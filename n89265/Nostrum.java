...
public class Nostrum {
	...
	public static void main(String[] args) throws FileNotFoundException {
		PrintStream fl = new PrintStream(new File("nestrum.txt")); 	
	...
	private static void test(PrintStream out) {
		...
		gest1.registaServico("104", new Net("Fast", "Para uso domestico", 17.00, "100Mb"));
	...
	private static void alineaD(PrintStream out) {
		...
		GestorServicos gest3 = new GestorServicos4(reg);
		gest3.registaServico("101", new TV("Basico", "Canais essenciais", 14.50, 20));
		gest3.registaServico("102", new TV("Mix", "Oferta variada de canais", 23.00, 80));
		gest3.registaServico("103", new TV("Premium", "Tudo o que possa imaginar. Inclui canais TV cine", 45.00, 120));
		gest3.registaServico("104", new Net("Fast", "Para uso domestico", 17.00, "100Mb"));
		gest3.registaServico("105", new Net("Fast++", "Para uso empresarial", 38.00, "1Gb"));
		
		Pacote c1 = new Pacote("TV+Net+Voz", "Pacote standard", 12);
		c1.add(gest3.getServico("102"));
		c1.add(gest3.getServico("104"));
		
		Servico s1 = gest3.eliminaServico("101"); // existe
		Servico s2 = gest3.eliminaServico("007"); // nao existe
